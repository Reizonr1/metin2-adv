...
void CSupportActor::SetName()
{
	...
	supportName+="'s Support";
	std::string supportnames = "'s Support";
...
DWORD CSupportActor::Summon(const char* supportName, LPITEM pSummonItem, bool bSpawnFar)
{
	...
	if (m_dwSummonItemVnum == 53001)
	{
		m_speciality = "Dragon Force";
	}
	else if (m_dwSummonItemVnum == 53003)
	{
		m_speciality = "Healing Force";
	}
	else
	{
		m_speciality = "/";
