...
class ExpandedTaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		if (app.ENABLE_OFFLINE_SHOP_SYSTEM):
			self.toggleButtonDict[ExpandedTaskBar.BUTTON_OFFLINE_SHOP] = self.GetChild("OfflineShopButton")
			self.toggleButtonDict[ExpandedTaskBar.BUTTON_OFFLINE_SHOP].SetParent(self)
