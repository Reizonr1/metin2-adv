...
class OfflineShopAdminPanelWindow(ui.ScriptWindow):
	...
	def ClickGetBackButton(self):
		...
		self.wndOfflineShopGetBack.Open(player.GetName() + "'s " + localeInfo.OFFLINE_SHOP)
		return True
...
class OfflineShopAddItemWindow(ui.ScriptWindow):
	...
	def Open(self, title):
		...
		self.board.SetTitleName("Add Offline Shop Item")		
		self.Refresh()
		self.SetCenterPosition()
		self.SetTop()
		self.Show()
...
class OfflineShopRemoveItemWindow(ui.ScriptWindow):
	...
	def Open(self, title):
		...
		self.tooltipItem = uiToolTip.ItemToolTip()
		self.tooltipItem.Hide()
		self.board.SetTitleName("Remove Offline Shop Item")		
		self.Refresh()
		self.SetCenterPosition()
		self.SetTop()
		self.Show()
...
class OfflineShopChangePriceWindow(ui.ScriptWindow):
	...
	def Open(self, title):
		...
		self.tooltipItem = uiToolTip.ItemToolTip()
		self.tooltipItem.Hide()
		self.board.SetTitleName("Change Price")	
		self.Refresh()
		self.Show()
	...
	def UnselectItemSlot(self, selectedSlotPos):
		...
		priceInputBoard = uiCommon.MoneyInputDialog()
		priceInputBoard.SetTitle(itemName + "'s new price")
		priceInputBoard.SetAcceptEvent(ui.__mem_func__(self.AcceptInputPrice))
		priceInputBoard.SetCancelEvent(ui.__mem_func__(self.CancelInputPrice))
		priceInputBoard.Open()
		self.priceInputBoard = priceInputBoard
...
class OfflineShopGetBackWindow(ui.ScriptWindow):
	...
	def Open(self, title):
		...
		self.tooltipItem = uiToolTip.ItemToolTip()
		self.tooltipItem.Hide()
		self.board.SetTitleName("Offline-shop unsold items")		
		self.Refresh()
		self.SetCenterPosition()
		self.SetTop()
		self.Show()
