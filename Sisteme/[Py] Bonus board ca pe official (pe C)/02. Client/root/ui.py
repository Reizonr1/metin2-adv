# Search class Button(Window): and replace with
...
# Search elif Type == "box": add before
...
# Search def LoadElementBox(self, window, value, parentWindow): add before
