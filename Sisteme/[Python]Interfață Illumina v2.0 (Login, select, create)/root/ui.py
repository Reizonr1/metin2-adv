...
class Input(Window):
	...
	def __init__(self, layer = "UI"):
		...
		self.__dictImages['LEFT'].LoadImage("d:/ymir work/ui/intro/login/input/board_left_01_normal.tga")
		self.__dictImages['CENTER'].LoadImage("d:/ymir work/ui/intro/login/input/board_center_01_normal.tga")
		self.__dictImages['RIGHT'].LoadImage("d:/ymir work/ui/intro/login/input/board_right_01_normal.tga")
...
class ThinBoardTWIX(Window):
	...
	def __init__(self, layer = "UI"):
		...
		CornerFileNames = [ "d:/ymir work/ui/intro/thinboard/Corner_"+dir+".tga" for dir in ["Shadow_LeftTop","Shadow_LeftBottom","Shadow_RightTop","Shadow_RightBottom","LeftTop","LeftBottom","RightTop","RightBottom"] ]
		LineFileNames = [ "d:/ymir work/ui/intro/thinboard/bar_"+dir+".tga" for dir in ["Left","Right","Top","Bottom"] ]
...
class PythonScriptLoader(object):
	...
	def LoadChildren(self, parent, dicChildren):
		...
		for ElementValue in ChildrenList:
			...
			elif Type == "thinboardtwix":
				parent.Children[Index] = ThinBoardTWIX()
				parent.Children[Index].SetParent(parent)
				self.LoadElementThinBoard(parent.Children[Index], ElementValue, parent)	
