...
class GameWindow(ui.ScriptWindow):
	...
	def Open(self):
		...
		self.KillGuiBg.SetPosition(wndMgr.GetScreenWidth()-140,130)
		
		self.KillBlauReich = ui.TextLine()
		self.KillBlauReich.SetFontName(locale.UI_DEF_FONT)
		self.KillBlauReich.SetPosition((wndMgr.GetScreenWidth()-145)-4, 158)
		self.KillBlauReich.SetText("               Oyuncu Sayýsý: ...")
	...
	def __BuildDebugInfo(self):
		...
		self.PrintMousePos.SetFontName(locale.UI_DEF_FONT)
	...
	# System kill song
	def __PlayMusicxd(self, filename):
		snd.PlaySound("BGM/" + filename)
	# System kill song
	...
	def __KillBlauReich(self, KillBlauReich):
		self.KillBlauReich.SetText("               Oyuncu Sayýsý: " + KillBlauReich)
