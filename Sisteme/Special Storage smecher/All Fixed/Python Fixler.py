	...
	class ExtendedInventoryWindow(ui.ScriptWindow):
		...
		def SelectItemSlot(self, itemSlotIndex):
			...
			if mouseModule.mouseController.isAttached():
				...
				if player.SLOT_TYPE_SKILL_BOOK_INVENTORY == attachedSlotType or player.SLOT_TYPE_UPGRADE_ITEMS_INVENTORY == attachedSlotType or player.SLOT_TYPE_STONE_INVENTORY == attachedSlotType or player.SLOT_TYPE_SANDIK_INVENTORY == attachedSlotType:
...
değiştir
			...
			elif player.SLOT_TYPE_INVENTORY == attachedType or player.SLOT_TYPE_SKILL_BOOK_INVENTORY == attachedType or player.SLOT_TYPE_UPGRADE_ITEMS_INVENTORY == attachedType or player.SLOT_TYPE_STONE_INVENTORY == attachedType or player.SLOT_TYPE_SANDIK_INVENTORY == attachedType:
...
mousemodule.py bitti
----------------------------------------------------

uiexchange.py deschide și adauga
...
uiinventory bidaha aç cauta bunu
...
uiinventory.py bitti
----------------------------------------------------------------------------


uiofflineshopbuilder.py aç ve cauta
...
uiprivateshopbuilder.py aç ve cauta
...
son kez şunu yap kardeşim uishop.py aç bunu bul
...
altındaki bunu aynen böyle yap
		if player.SLOT_TYPE_INVENTORY == attachedSlotType:

bunu böyle bırak

aynı fonksiyonda bunu bul
...
bunu böyle değiştir
			...
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Bu envanterden birsey satamazsin! ")
			snd.PlaySound("sound/ui/loginfail.wav")

bu kadar kardeşim saygılarla. Dracarys - BURHANBEY
